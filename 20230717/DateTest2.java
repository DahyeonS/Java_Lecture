...
//		Date 클래스 객체에 년도를 저장할 때는 1900년을 빼서 넣어야 하고 월을 저장할 때는
//		1을 빼서 넣어야 한다.
		Date date4 = new Date(2023 - 1900, 7 - 1, 17);
		System.out.println(sdf.format(date4));
		
		Date date5 = new Date(123, 6, 17, 11, 18);
		System.out.println(sdf.format(date5));
		
		Date date6 = new Date(123, 6, 17, 11, 19, 21);
