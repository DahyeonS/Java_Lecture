...
//		도서정보를 만든다.
//		출판일은 날짜 데이터를 만들어 BookVO 클래스에 writeDate 필드에 넣어주면
//		다른 곳에서 사용할 일이 없다.
//		이럴 경우 익명으로 객체를 만들어 사용하면 편리하다.
		BookVO book1 = new BookVO("java", "둘리", "a출판사", 
...
//		가질 수 있도록 hashcode() 메소드를 Override 시켜 사용하면 "같다"가 출력된다.
