...
//		같은(비슷한) 기능을 실행하는 메소드의 인수가 다를 경우 많은 수의 오버로딩이 필요하다.
		System.out.println("sum(1, 2) = " + sum(1, 2));
		System.out.println("sum(1, 2, 3) = " + sum(1, 2, 3));
		System.out.println("sum(1, 2, 'a') = " + sum(1, 2, 'a')); // 'a' = 97
		System.out.println("sum(1, 2, \"a\") = " + sum(1, 2, "a"));
		System.out.println("sum(1, 2, 3, 4) = " + sum(1, 2, 3, 4));
		System.out.println("sum(1, 2, 3, 4, 5) = " + sum(1, 2, 3, 4, 5));
		System.out.println("========================================");
		
//		메소드의 인수를 배열로 구성하면 많은 수의 오버로딩이 필요없지만 인수를 배열로 선언하고
...
//	가변 인수는 인수 목록 맨 마지막에 딱 1번만 사용할 수 있다.
